...
<div class="relative mt-1.5 w-full" bind:this={menu}>
	...
	{#if show}
		<div
			...
			class="z-50 lg:origin-top-left lg:mt-5 absolute bottom-0  lg:bottom-auto right-0 lg:right-auto lg:top-0 lg:left-0 bg-surface px-2 py-2 space-y-2 rounded-xl shadow-lg "
		>
			<slot />
		</div>
	{/if}
