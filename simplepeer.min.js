				...
				function (e, t, n) {
					(function () {
						(function () {
							...
							function g(e) {
								for (
									var t = 0 > e.length ? 0 : 0 | m(e.length),
										n = d(t),
										r = 0;
									r < t;
									r += 1
				...
				function (e, t) {
					...
					t.exports = function (e, t, r) {
						if (!e || "string" == typeof e)
							throw new TypeError(
								"Please pass an Error to err-code"
							);
						r || (r = {}),
					...
					r(
						...
						r(
							...
							function (e, t, n) {
								...
								return (
									(s += ". Received type ".concat(typeof n)),
									s
								);
							},
							TypeError
				...
				function (e, t) {
					(function (n) {
						(function () {
							...
							e("inherits")(r, d);
							for (
								var l, c = i(s.prototype), u = 0;
								u < c.length;
								u++
							)
								(l = c[u]),
									r.prototype[l] ||
										(r.prototype[l] = s.prototype[l]);
				...
				function (e, t) {
					(function (n, r) {
						(function () {
							...
							function m(e, t) {
								t.readingMore ||
									((t.readingMore = !0), n.nextTick(b, e, t));
							}
							function b(e, t) {
								for (
									;
							...
							function C(e) {
								var t = e._readableState;
								(t.readableListening =
									0 < e.listenerCount("readable")),
									t.resumeScheduled && !t.paused
										? (t.flowing = !0)
										: 0 < e.listenerCount("data") &&
										  e.resume();
							}
							function R(e) {
							...
							(s.prototype.read = function (e) {
								...
								(s.prototype.removeListener = function (e, t) {
									var r = I.prototype.removeListener.call(
										this,
										e,
										t
									);
									return (
										"readable" === e && n.nextTick(C, this),
										r
									);
								}),
								(s.prototype.removeAllListeners = function (e) {
									var t =
										I.prototype.removeAllListeners.apply(
											this,
											arguments
										);
									return (
								...
								"function" == typeof Symbol &&
									(s.prototype[Symbol.asyncIterator] =
										function () {
											return (
												void 0 === B &&
													(B = e(
						...
						(function () {
							...
							function l(t) {
								...
								return n || V.call(l, this)
									? void ((this._writableState = new s(
											t,
											this,
											n
									  )),
					...
					class p extends d.Duplex {
						constructor(e) {
							if (
								...
								(this.channelConfig =
									e.channelConfig || p.channelConfig),
								(this.channelNegotiated =
									this.channelConfig.negotiated),
								...
								(this.trickle =
									void 0 === e.trickle || e.trickle),
								(this.allowHalfTrickle =
									void 0 !== e.allowHalfTrickle &&
									e.allowHalfTrickle),
								(this.iceCompleteTimeout =
									e.iceCompleteTimeout || 5000),
								(this.destroyed = !1),
								(this.destroying = !1),
								(this._connected = !1),
							...
							if (!this.destroying) {
								...
								this._debug("signal()"),
									e.renegotiate &&
										this.initiator &&
										(this._debug(
											"got request to renegotiate"
										),
										this._needsNegotiation()),
									e.transceiverRequest &&
										this.initiator &&
										(this._debug(
											"got request for transceiver"
										),
										this.addTransceiver(
									...
									e.sdp &&
										this._pc
											.setRemoteDescription(
												new this._wrtc.RTCSessionDescription(
													e
												)
											)
											.then(() => {
						...
						send(e) {
							if (!this.destroying) {
								if (this.destroyed)
									throw l(
										new Error(
											"cannot send after peer is destroyed"
										),
										"ERR_DESTROYED"
									);
						...
						addStream(e) {
							if (!this.destroying) {
								if (this.destroyed)
									throw l(
										new Error(
											"cannot addStream after peer is destroyed"
										),
										"ERR_DESTROYED"
									);
						...
						addTrack(e, t) {
							...
							if (this.destroyed)
								throw l(
									new Error(
										"cannot addTrack after peer is destroyed"
									),
									"ERR_DESTROYED"
								);
						...
						removeTrack(e, t) {
							...
							if (this.destroyed)
								throw l(
									new Error(
										"cannot removeTrack after peer is destroyed"
									),
									"ERR_DESTROYED"
								);
						...
						negotiate() {
							if (!this.destroying) {
								if (this.destroyed)
									throw l(
										new Error(
											"cannot negotiate after peer is destroyed"
										),
										"ERR_DESTROYED"
									);
								this.initiator
						...
						_setupData(e) {
							...
							(this._channel = e.channel),
								...
								"number" ==
									typeof this._channel
										.bufferedAmountLowThreshold &&
									(this._channel.bufferedAmountLowThreshold =
										u),
							...
							this._closingInterval = setInterval(() => {
								this._channel &&
								"closing" === this._channel.readyState
											...
											n && (n.ip || n.address)
												...
												? ((this.remoteAddress =
												  ...
												  (this.remotePort =
														+n.portNumber))
												: "string" ==
														typeof e.googRemoteAddress &&
												  ((n =
														e.googRemoteAddress.split(
															":"
														)),
